...
/** 
*  
 * createStroke(config: {location: PointSignal, completionEvent: EventSource, brushSize: number | void, brushType: ?SceneModule.DynamicExtrusion.BrushType, brushDistance: number | void, textureWidthSize: number | void, textureHeightStep: number | void, material: ?MaterialBase, extrudeInCPU: boolean | void}): void
 *  
 * 
