...
* 
 *  
 * polybezier(config: { keyframes: Array<number>, knots: Array<number> | void, tangents: Array<number> | void }): ScalarSampler
 * polybezier(config: { keyframes: Array<Array<number>>, knots: Array<number> | void, tangents: ?Array<Array<number>> }): ArrayOfScalarSamplers
 *  
 * 
 ...
 */polybezier(config: { keyframes: Array<number>, knots: Array<number> | void, tangents: Array<number> | void }): ScalarSampler;
    ...
    polybezier(config: { keyframes: Array<Array<number>>, knots: Array<number> | void, tangents: Array<Array<number>> | void }): ArrayOfScalarSamplers;
...
* 
 *  
 * polyline(config: { keyframes: Array<number>, knots: Array<number> | void }): ScalarSampler
 * polyline(config: { keyframes: Array<Array<number>>, knots: Array<number> | void }): ArrayOfScalarSamplers
 * polyline(config: { keyframes: Array<Rotation>, knots: Array<number> | void }): RotationSampler
 *  
 * 
...
* 
 *  
 * sequence(config: { samplers: Array<ScalarSampler>, knots: Array<number> | void }): ScalarSampler
 * sequence(config: { samplers: Array<ArrayOfScalarSamplers>, knots: Array<number> | void }): ArrayOfScalarSamplers
 *  
 * 
