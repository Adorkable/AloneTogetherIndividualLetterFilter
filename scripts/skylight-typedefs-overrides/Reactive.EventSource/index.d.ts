...
declare interface EventSource<EventType> {
        /** 
        *  
         ...
         */
        subscribe(callback: (event: mixed<EventType>) => void): Subscription
                ;
        ...
        *  
         ...
         */
        subscribeWithSnapshot(snapshot: { [name: string]: Signal }, callback: (event: mixed<EventType>, snapshot: mixed<EventType>) => void): Subscription
                ;
        ...
        *  
         ...
         * **Note**: `subscribe` and `subscribeOnNext` functions are completely equivalent.
         */
        subscribeOnNext(callback: (event: mixed<EventType>) => void): Subscription
                ;
        ...
        *  
         ...
         */
        skip(count: number): EventSource<EventType>
                ;
        ...
        *  
         ...
         */
        select(property: string): EventSource<EventType>
                ;
        ...
        *  
         ...
         */
        take(count: number): EventSource<Array<EventType>>;
} 
